;------------------------------------------------------------------------------
; pa_io.asm -- pugasm: the command line, output streams, and the input stack
; (source files, INCLUDEs and macro expansions) that READLINE takes lines from.
;------------------------------------------------------------------------------
...
EXT_LST     FCN  ".LST"
;------------------------------------------------------------------------------
; Output streams: +0 handle, +1 open, +2 bytes buffered, +4 the 256-byte buffer.
;------------------------------------------------------------------------------
